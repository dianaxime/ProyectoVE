...
router.get('/statistics/players-of-sport-tournament/:startdate/:enddate/:sport', verifyAuth, getPlayersOfSportInTournament);
router.get('/statistics/teams-tournament/:startdate/:enddate', verifyAuth, getTeamsOfTournament);
router.get('/statistics/teams-of-sport-tournament/:startdate/:enddate/:sport', verifyAuth, getTeamsOfASportInTournament);
router.get('/statistics/genders-tournament/:startdate/:enddate', verifyAuth, getGenderOfTournament);
router.get('/statistics/genders-of-sport-tournament/:startdate/:enddate/:sport', verifyAuth, getGenderOfSportInTournament);
