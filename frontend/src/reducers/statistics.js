...
import * as types from '../types/statistics';
  ...
  export const isFetchingAssistanceClub = state => state.isFetchingAssistanceClub;
  ...
  export const isFetchingAssistanceClubs = state => state.isFetchingAssistanceClubs;
  ...
  export const isFetchingScholarss = state => state.isFetchingScholarss;
  ...
  export const isFetchingParticipationwkTime = state => state.isFetchingParticipationwkTime;
  ...
  export const isFetchingParticipationwk = state => state.isFetchingParticipationwk;
  ...
  export const isFetchingParticipationwkTimeg = state => state.isFetchingParticipationwkTimeg;
  ...
  export const isFetchingParticipationwkG = state => state.isFetchingParticipationwkG;
