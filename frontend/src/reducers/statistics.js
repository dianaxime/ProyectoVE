...
const byIdParticipationAssociations = (state = [], action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATIONS_FETCH_COMPLETED: {
      return action.payload.entities;
    }
    default: {
      return state;
...
const isFetchingParticipationAssociations = (state = false, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATIONS_FETCH_STARTED: {
      return true;
    }
    case types.PARTICIPATION_ASSOCIATIONS_FETCH_COMPLETED: {
      return false;
    }
    case types.PARTICIPATION_ASSOCIATIONS_FETCH_FAILED: {
      return false;
    }
    default: {
      return state;
...
const errorParticipationAssociations = (state = null, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATIONS_FETCH_FAILED: {
      return action.payload.error;
    }
...
const byIdParticipationAssociation = (state = [], action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_FETCH_COMPLETED: {
      return action.payload.entities;
    }
    default: {
      return state;
...
const isFetchingParticipationAssociation = (state = false, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_FETCH_STARTED: {
      return true;
    }
    case types.PARTICIPATION_ASSOCIATION_FETCH_COMPLETED: {
      return false;
    }
    case types.PARTICIPATION_ASSOCIATION_FETCH_FAILED: {
      return false;
    }
    default: {
      return state;
...
const errorParticipationAssociation = (state = null, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_FETCH_FAILED: {
      return action.payload.error;
    }
...
const byIdParticipationAssociationF = (state = [], action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_F_FETCH_COMPLETED: {
      return action.payload.entities;
    }
    default: {
      return state;
...
const isFetchingParticipationAssociationF = (state = false, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_F_FETCH_STARTED: {
      return true;
    }
    case types.PARTICIPATION_ASSOCIATION_F_FETCH_COMPLETED: {
      return false;
    }
    case types.PARTICIPATION_ASSOCIATION_F_FETCH_FAILED: {
      return false;
    }
    default: {
      return state;
...
const errorParticipationAssociationF = (state = null, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_F_FETCH_FAILED: {
      return action.payload.error;
    }
...
const byIdParticipationAssociationM = (state = [], action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_M_FETCH_COMPLETED: {
      return action.payload.entities;
    }
    default: {
      return state;
...
const isFetchingParticipationAssociationM = (state = false, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_M_FETCH_STARTED: {
      return true;
    }
    case types.PARTICIPATION_ASSOCIATION_M_FETCH_COMPLETED: {
      return false;
    }
    case types.PARTICIPATION_ASSOCIATION_M_FETCH_FAILED: {
      return false;
    }
    default: {
      return state;
...
const errorParticipationAssociationM = (state = null, action) => {
  switch (action.type) {
    case types.PARTICIPATION_ASSOCIATION_M_FETCH_FAILED: {
      return action.payload.error;
    }
...
export default combineReducers({
  ...
  byIdParticipationAssociations,
  isFetchingParticipationAssociations,
  errorParticipationAssociations,
  byIdParticipationAssociation,
  isFetchingParticipationAssociation,
  errorParticipationAssociation,
  byIdParticipationAssociationF,
  isFetchingParticipationAssociationF,
  errorParticipationAssociationF,
  byIdParticipationAssociationM,
  isFetchingParticipationAssociationM,
  errorParticipationAssociationM,
});
...
export const getParticipationAssociations = state => state.byIdParticipationAssociations;
export const getIsFetchingParticipationAssociations = state => state.isFetchingParticipationAssociations;
export const getFetchingParticipationAssociationsError = state => state.errorParticipationAssociations;
export const getParticipationAssociation = state => state.byIdParticipationAssociation;
export const getIsFetchingParticipationAssociation = state => state.isFetchingParticipationAssociation;
export const getFetchingParticipationAssociationError = state => state.errorParticipationAssociation;
export const getParticipationAssociationF = state => state.byIdParticipationAssociationF;
export const getIsFetchingParticipationAssociationF = state => state.isFetchingParticipationAssociationF;
export const getFetchingParticipationAssociationFError = state => state.errorParticipationAssociationF;
export const getParticipationAssociationM = state => state.byIdParticipationAssociationM;
export const getIsFetchingParticipationAssociationM = state => state.isFetchingParticipationAssociationM;
export const getFetchingParticipationAssociationMError = state => state.errorParticipationAssociationM;